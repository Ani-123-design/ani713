...
y5["month"]=pd.to_datetime(y5["order_purchase_date"])


# In[160]:


y5['Month1'] = y5["month"].dt.strftime('%m')
y5['Year1'] = y5["month"].dt.strftime('%Y')
y5
...
y7=y5.groupby(['Month1','Year1']).agg({'sales':np.sum})
